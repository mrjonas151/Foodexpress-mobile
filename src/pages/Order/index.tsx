...
export default function Order(){
    ...
    function handleChangeProduct(product: ProductProps){
        setProductSelected(product);
    }

    async function handleAdd(){
        const response = await api.post('/order/itemAdd', {
            order_id: route.params?.order_id,
    ...
    async function handleDeleteItem(item_id:string){
        await api.delete('/order/itemRemove',{
            params:{
                item_id: item_id
            }
        })
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.qtdContainer}>
                ...
                <TextInput style={[styles.input, {width: '60%', textAlign: 'center'}]} placeholder="1" placeholderTextColor="gray" keyboardType="numeric" value={amount} onChangeText={setAmount}></TextInput>
            </View>
